...
wget -nv https://raw.githubusercontent.com/haavape/maximo/$branchName/src/mas/mas-operator.yaml -O /tmp/mas-operator.yaml
...
oc apply -f https://raw.githubusercontent.com/haavape/maximo/$branchName/src/strimzi/strimzi-operator.yaml
...
oc apply -f https://raw.githubusercontent.com/haavape/maximo/$branchName/src/strimzi/strimzi-service.yaml
...
#deploy mas
wget -nv https://raw.githubusercontent.com/haavape/maximo/$branchName/src/mas/mas-service.yaml -O /tmp/mas-service.yaml
...
kill $PID
wget -nv https://raw.githubusercontent.com/haavape/maximo/$branchName/src/mas/slsCfg.yaml -O /tmp/slsCfg.yaml
...
wget -nv https://raw.githubusercontent.com/haavape/maximo/$branchName/src/mas/basCfg.yaml -O /tmp/basCfg.yaml
...
kill $PID
wget -nv https://raw.githubusercontent.com/haavape/maximo/$branchName/src/mas/mongoCfg.yaml -O /tmp/mongoCfg.yaml
