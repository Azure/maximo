...
echo "================ OCP DEPLOY START ================"
 ...
 wget -nv https://raw.githubusercontent.com/haavape/maximo/$branchName/src/machinesets/ocs.yaml -O /tmp/OCPInstall/ocs.yaml
...
then
 ...
 wget -nv https://raw.githubusercontent.com/haavape/maximo/$branchName/src/storageclasses/azurefiles-standard.yaml -O /tmp/OCPInstall/azurefiles-standard.yaml
 ...
 wget -nv "https://raw.githubusercontent.com/haavape/maximo/$branchName/src/installers/azure_premium_files_deploy.sh" -O /tmp/azure_premium_files_deploy.sh
 chmod +x /tmp/azure_premium_files_deploy.sh
 sudo -E /tmp/azure_premium_files_deploy.sh

 sudo -E /tmp/OCPInstall/oc apply -f https://raw.githubusercontent.com/haavape/maximo/$branchName/src/storageclasses/persistent-volume-binder.yaml
