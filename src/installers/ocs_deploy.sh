...
oc apply -f https://raw.githubusercontent.com/haavape/maximo/$branchName/src/ocs/ocs-create-cluster.yaml
...
oc apply -f https://raw.githubusercontent.com/haavape/maximo/$branchName/src/CloudPakForData/3.5/Db2Warehouse/rook-ceph-operator-config.yaml -n openshift-storage
